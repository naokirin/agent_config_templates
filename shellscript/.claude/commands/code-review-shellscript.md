---
description: Review shell script code using shellscript-code-reviewer agent
---

# Review Shell Script Code

Review the given changes (or the latest diff) using the **shellscript-code-reviewer** agent.
